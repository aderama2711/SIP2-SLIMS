            ...
            while True:
                ...
                if string[0:2] == "99":
                    ...
                    if string[0:2] == "17":
                        ...
                        mycursor.execute(
                            "SELECT * FROM item WHERE item_code='" + item_id + "'"
                        )
                        ...
                        if len(myresult) == 0:
                            ...
                            mycursor = mydb.cursor()
                            mycursor.execute(
                                "SELECT * FROM search_biblio WHERE biblio_id="
                                + str(biblio_id)
                            )
                            myresult = mycursor.fetchall()
                            title = myresult[0][1]
                            ...
                            mycursor = mydb.cursor()
                            mycursor.execute(
                                "SELECT * FROM loan WHERE item_code='"
                                + item_id
                                + "' ORDER BY `loan_id`"
                            )
                            myresult = mycursor.fetchall()
                            ...
                            if (
                                last[8] == 1 and last[9] == 1
                            ):  # if is_lent 1 and is_return 1 then book returned and available
                                cs = "03"
                            elif (
                                last[8] == 1 and last[9] == 0
                            ):  # if is_lent 1 and is_return 0 then book in lent and not available
                                cs = "02"
                                due_date = last[4]
                            else:
                                cs = "03"
                    ...
                    # patron status
                        ...
                        mycursor = mydb.cursor()
                        mycursor.execute(
                            "SELECT * FROM member WHERE member_id='" + user_id + "'"
                        )
                        myresult = mycursor.fetchall()
                        ...
                        if len(myresult) == 0:
                            ...
                            mycursor = mydb.cursor()
                            mycursor.execute(
                                "SELECT * FROM fines WHERE member_id='" + user_id + "'"
                            )
                            myresult = mycursor.fetchall()
                            debet = 0
                            credit = 0
                            ...
                            if debet - credit != 0:
                                resp = bytes(
                                    ...
                                    + "|AE"
                                    + name
                                    + "|BLN|AFANDA DIKENAKAN DENDA, SILAHKAN HUBUNGI MEJA SIRKULASI"
                                    + "\r",
                                    "utf-8",
                                )
                            resp = bytes(
                        ...
                        if len(myresult) == 0:
                            ...
                            if debet - credit != 0:
                                resp = bytes(
                                    ...
                                    + "|AE"
                                    + name
                                    + "|BLY|AFANDA DIKENAKAN DENDA, SILAHKAN HUBUNGI MEJA SIRKULASI"
                                    + "\r",
                                    "utf-8",
                                )
                    ...
                    # check out
                        ...
                        if debet - credit != 0:
                            resp = bytes(
                                ...
                                + "AH|AB"
                                + item_id
                                + "|AJ|AFANDA DIKENAKAN DENDA, SILAHKAN HUBUNGI MEJA SIRKULASI"
                                + "\r",
                                "utf-8",
                            )
                            ...
                            mycursor = mydb.cursor()
                            mycursor.execute(
                                "SELECT * FROM mst_member_type WHERE member_type_id='"
                                + str(member_type)
                                + "'"
                            )
                            myresult = mycursor.fetchall()
                            ...
                            if loan == loan_limit:
                                resp = bytes(
                                    ...
                                    + "|AH|AB"
                                    + item_id
                                    + "|AJ|AFSUDAH MENCAPAI LIMIT PEMINJAMAN"
                                    + "\r",
                                    "utf-8",
                                )
                                ...
                                if len(myresult) == 0:
                                    ...
                                    if loaned == 1:
                                        ...
                                        val = (
                                            ...
                                            (
                                                datetime.datetime.now()
                                                + datetime.timedelta(days=loan_periode)
                                            ).strftime("%Y-%m-%d"),
                                            1,
                                            datetime.datetime.now().strftime(
                                                "%Y-%m-%d %H:%M:%S"
